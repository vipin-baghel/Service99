...
import com.service99.ui.salon.women.BodyPolishWomen;
import com.service99.ui.utilities.Help;
import com.thekhaeng.pushdownanim.PushDownAnim;

import java.util.Objects;

public class BodyPolishMen extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_body_polish_men);

        //toolbar
        Objects.requireNonNull(getSupportActionBar()).setTitle("Body Polish for Men");
            ...
            PushDownAnim.setPushDownAnimTo(l)
                    ...
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //on click
                            Help.schedule(BodyPolishMen.this, "Service:\n" + t.getText());
