...
public class MassageWomen extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_massage_women);

        //toolbar
        Objects.requireNonNull(getSupportActionBar()).setTitle("Massage for Women");
            ...
            PushDownAnim.setPushDownAnimTo(l)
                    ...
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //on click
                            Help.schedule(MassageWomen.this, t.getText().toString(), p.getText().toString());
