...
public class Threading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //toolbar
        Objects.requireNonNull(getSupportActionBar()).setTitle("Threading for Women");
        ...
        PushDownAnim.setPushDownAnimTo(l1)
                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //on click
                        Help.schedule(Threading.this, "Service:\nEyebrows Threading for Women");
        ...
        PushDownAnim.setPushDownAnimTo(l4)
                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //on click
                        Help.schedule(Threading.this, "Service:\nFull Face Threading Threading for Women");
        ...
        PushDownAnim.setPushDownAnimTo(l6)
                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //on click
                        Help.schedule(Threading.this, "Service:\nEyebrows + Upperlips + Forehead Threading for Women");
